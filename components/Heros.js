  ...
  return (
    <div className="flex flex-col ">
      <div className=" z-10 grid mt-[100px] grid-cols-1 lg:grid-cols-12 min-h-screen items-center  justify-between gap-4 lg:gap-0">
        {/* Text Section */}
        <div className="media col-span-7 place-self-center">
          ...
          >
            <button
              variant="ghost"
              className="bot  bg-[#d3e8d7] hover:bg-[#8f9e92] text-black rounded-2xl transition-colors w-[200px] h-[50px] flex items-center justify-center"
